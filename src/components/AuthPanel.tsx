...
export function AuthPanel(props: AuthPanelProps) {
  const { isConfigured, isLoading, error, status: authStatus, authDebugInfo, onSignIn, onSignUp, onResendVerification, onVerifyEmailOtp, featureFlags, onOAuth, onRequestPhoneOtp, onVerifyPhoneOtp, phoneResendRemainingMs, emailResendRemainingMs, onContinueAsGuest } = props;
