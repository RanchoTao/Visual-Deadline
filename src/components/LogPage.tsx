...
export function LogPage({ tasks, goals, profile, pressure, pressureHistory, achievements, aiArtifacts, onAIReportGenerated, onRecalculatePressureHistory, onRecalibrate, onDelete, onEdit, onRestore, onReviewNoteChange }: DataCenterProps) {
