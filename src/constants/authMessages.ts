export const EMAIL_VERIFICATION_SENT_MESSAGE = '验证邮件已发送，请前往邮箱完成验证。验证完成后回到这里登录。';
...
export const EMAIL_MAYBE_REGISTERED_MESSAGE = '该邮箱可能已注册，请直接登录；如果尚未验证，请点击重新发送验证邮件。';
