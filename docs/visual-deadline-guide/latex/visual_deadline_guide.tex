...
Timeline 将目标、项目与任务投影到同一套连续真实日期坐标，提供日、周、月与季度缩放、今天线、并行任务、进度、依赖和未排期区域。人生阶段不与本周任务共享横轴。

\VDscreenshot{10_life_timeline.png}{人生时间坐标轴}{展示统一日期甘特排期、并行任务、里程碑、进度和今天线。}
...
人生 & Life Map / Timeline & \statusdone & 使用用户真实目标与任务数据 \\
